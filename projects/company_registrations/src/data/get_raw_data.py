...
for i in range(1, 6):
    query_dict = {
        ...
        'sortOrder': ['D'],
        'searchField': ['Title'],
        'dialog': ['{"folder":"403","language":"English","totalColumns":3,"columns":["Title","Month","Year of report"]}']
    }
...
# %%
    for doc in doc_list:
        ...
        raw_file_loc = os.path.join(raw_path, f"mca_raw_{doc['column2']}_{doc['column3']}.{curr_link['docType']}")
        print(raw_file_loc)
